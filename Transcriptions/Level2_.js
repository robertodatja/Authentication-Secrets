...
//II7.1 So one of the most common things that we don't commit when we're creating Node projects are the Node modules
...
-
//II.7.2 The other thing that is inside this template of gitignore is of course the .env file
